...
class _NotePageState extends State<NotePage> {
  ...
  Future<void> _updateNote(
      String noteId, String title, String content, String category) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content: Text(
                  "Failed to update note. ${jsonDecode(response.body)['error']}")),
        );
      }
    } catch (e) {
  ...
  Future<void> _createNote(BuildContext context) async {
    ...
    try {
      final String apiUrl = "http://localhost:5000/api/note/create";
